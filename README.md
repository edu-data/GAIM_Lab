...
> 💡 **v8.3 최신 기능** — Gemini 2.0 Flash 기반 AI 코치 챗봇으로 **교육학 석학 7인과 1:1 실시간 대화 코칭**이 가능합니다.

### ✨ 핵심 기능

| 영역 | 기능 | 도입 버전 |
| :--: | ---- | :--: |
| 🤖 | **AI 코치 챗봇** — Gemini 2.0 Flash 기반, 7인 석학 페르소나 1:1 대화 코칭 | v8.3 |
| � | **실시간 코칭** — 카메라 녹화 → 세션 종료 시 Gemini 7차원 자동 평가 | v8.2 |
| 🎬 | **클라이언트 분석** — 백엔드 없이 브라우저에서 직접 영상 분석 (GitHub Pages) | v8.0 |
| 📐 | **7차원 Gemini LLM 평가** — 7개 차원 모두 Gemini AI가 채점 | v8.0 |
| 📊 | **배치/코호트 분석** — Welch's t-test, Cohen's d 통계 비교 | v8.2 |
| 🗣️ | **화자 분리** — pyannote 3.3 기반 교사/학생 발화 분류 | v5.0 |
| 🔬 | **신뢰도 검증** — Test-Retest r=0.68, ±5pt 일치 82.6% | v6.0 |
| � | **PWA** — 오프라인 설치, Service Worker 캐싱 | v7.1 |
...
| 영상당 처리 시간 | **~1.5분** (TURBO MODE) |
| AI 에이전트 | **8개** (병렬·순차 파이프라인) |
| AI 코치 페르소나 | **7인** (Shulman · Vygotsky · Bruner · Dewey · Freire · Bloom · Gardner) |
...
18개 수업 영상 배치 분석 기준, 버전별 핵심 지표 변화:

| 버전 | 평균 점수 | 점수 범위 | 등급 분포 | 핵심 변경 |
| :--: | :--: | :--: | ---- | ---- |
| **v8.0** (최신) | **76.1점** | 67~84 (17pt) | B×5 · C+×4 · C×7 · D+×1 | 7차원 전체 Gemini LLM 평가 |
| v7.0 | 76.2점 | 67~86 (19pt) | B×5 · C+×5 · C×6 · D+×2 | Pydantic 계약 + 구간화 채점 |
| v5.0 | 77.4점 | 71~85 (14pt) | A-×4 · B+×11 · B×2 · B-×1 | 화자 분리 (pyannote 3.3) |
| v4.2 | 77.0점 | 72~82 (10pt) | A-×2 · B+×13 · B×3 | 프레임 경로 버그 수정 |
| v4.1 | 76.8점 | 72~83 (11pt) | A-×11 · B+×4 · B×3 | STT 기반 차별화 강화 |

> ✅ **v8.0 핵심 개선**: v7.2 대비 평균 59.9 → **76.1** (+16.2pt), F등급 8개 → **0개**, B등급 0개 → **5개**
...
| 페이지 | 링크 |
| ------ | ---- |
| 🏠 홈페이지 | [edu-data.github.io/GAIM_Lab/app/](https://edu-data.github.io/GAIM_Lab/app/) |
| 🤖 AI 코치 매칭 | [edu-data.github.io/GAIM_Lab/app/#/mentor](https://edu-data.github.io/GAIM_Lab/app/#/mentor) |
| 📊 대시보드 | [edu-data.github.io/GAIM_Lab/app/#/dashboard](https://edu-data.github.io/GAIM_Lab/app/#/dashboard) |
| � 실시간 코칭 | [edu-data.github.io/GAIM_Lab/app/#/live](https://edu-data.github.io/GAIM_Lab/app/#/live) |
| � 성장 경로 | [edu-data.github.io/GAIM_Lab/app/#/growth](https://edu-data.github.io/GAIM_Lab/app/#/growth) |
| 📋 배치 대시보드 | [18개 영상 시각화 + 화자 분리](https://edu-data.github.io/GAIM_Lab/batch_dashboard.html) |
| 🏆 최고점 리포트 | [84점 영상 상세 분석](https://edu-data.github.io/GAIM_Lab/best_report_110545.html) |
| 📊 FIAS 대시보드 | [Flanders 상호작용 분석](https://edu-data.github.io/GAIM_Lab/fias-dashboard.html) |
| 📄 종합 보고서 | [18개 영상 종합 분석](https://edu-data.github.io/GAIM_Lab/comprehensive_report.html) |
