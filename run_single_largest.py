"""
GAIM Lab - 용량 최대 영상 단일 분석
20251209_110545.mp4 (1,653 MB) 분석
"""
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print(f"🧪 GAIM Lab - 용량 최대 영상 분석")
    print(f"📁 영상: {video.name} ({video.stat().st_size / 1024 / 1024:.1f} MB)")
    print("=" * 60)

    analyze_single(video, PROJECT_ROOT / "output" / "largest_video_test")
